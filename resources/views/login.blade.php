...
<body>
    <div style="background-image: url('/img/image-mesh-gradient.png'); no-repeat; background-size: cover; background-position: center;"  class="min-h-screen flex flex-col items-center justify-center">
        <div class="bg-[#b57238] p-5 border-2 border-solid rounded-lg mr-2 ml-2 shadow-2xl shadow-white">
            ...
            <form method="POST" action="{{ route('login.post') }}" class="bg-[#eba860] p-5 border rounded-xl">
            @csrf
                ...
                <div class="flex justify-between items-center w-full mb-2">
                    ...
                    <a href="#" class="text-xs text-[#0E00AB] underline hover:text-blue-600 transition duration-300">
                        ¿Has olvidado la contraseña?
                    </a>
                </div>

                <a href="/register" class="block text-xs text-[#0E00AB] text-center underline hover:text-blue-600 transition duration-300">¿No tienes cuenta? Registrarse</a>
                @if ($errors->any())
